//Bug#40328
#ifndef _CS75XX_IPC_IPLIP_H_
#define _CS75XX_IPC_IPLIP_H_


/*
 *  Defined for MIB
 */
#define  CS_IPLIP_MIB_PHY_ADDR      0xF6400098
#define  CS_IPLIP_MIB_PHY_ADDR_SIZE 0x100
...
typedef struct cs_iplip_mib_pe_s {
	/* PE 1 MIB: IPLIP */
	cs_iplip_mib_ni_t   iplip_ni_mib;
	cs_iplip_mib_ipc_t  iplip_ipc_mib;
} __attribute__ ((__packed__)) cs_iplip_mib_pe_s;
