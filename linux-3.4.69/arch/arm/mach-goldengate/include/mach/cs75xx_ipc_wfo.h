...
typedef struct mib_pcie_s {
	__u32   PCIeRxFrameCount;
	__u32   PCIeRXByteCount;
	__u32   PCIeTXByteCount;
	__u32   PCIeTXRetryCount;
	__u32   PCIeTXErrorCount;
	__u32   PCIeTxA9FameCount;
	__u32   PCIeTxEthFrameCount;
	__u32   PCIeTxPEFameCount;
	__u32   PCIeDropFrameCount;
	__u32	rsvd[3];
} __attribute__ ((__packed__)) cs_mib_pcie_t;

typedef struct mib_ni_s {
	__u32   NIRxFrameCount;
	__u32   NIRxByteCount;
	__u32	NIRxA9FrameCount;
	__u32   NITXByteCount;
	__u32   NITXErrorCount;
	__u32   NITXPCIeFrameCount;
	__u32   NITxA9FrameCount;
	__u32   NITxPEFrameCount;
	__u32   NIDropNIFrameCount;
	__u32	rsvd[3];
} __attribute__ ((__packed__)) cs_mib_ni_t;

typedef struct mib_wlan_s {
	__u32   WLANRxPackets;
	__u32   WLANTxPackets;
	__u32   WLANRxBytes;
	__u32   WLANTxBytes;
	...
	__u32   WLANTxErrors;
	__u32   WLANMulticast;
	__u32   WLANCollisions;
	__u32   WLANRxOverErrors;
	__u32   WLANRxCrcErrors;
	__u32   WLANRxFrameErrors;
	__u32   WLANRxFifoErrors;
} __attribute__ ((__packed__)) cs_mib_wlan_t;
#endif

typedef struct mib_pcie_s {
	__u32   PCIeRxFrameCount;	// WiFi RX frame count
	__u32   PCIeTxFrameCount;	// WiFi TX frame count

	__u32   PCIeRxByteCount;	// WiFi RX byte count
	__u32   PCIeTxByteCount;	// WiFi TX byte count

	__u32   PCIeTxErrorCount;
	__u32   PCIeTxPEFrameCount;	// PE to PE TX frame count

	__u32   PCIeDropFrameCount;
	__u32   PCIeRxEOLCount;

	__u32   PCIeRxORNCount;
	__u32   PCIeRxsErrorCount;

	__u32   PCIeTxsErrorCount;
	__u32   PCIeRxBcastFrameCount;

	__u32   PCIeTxBcastFrameCount;
	__u32   PCIeRxMcastFrameCount;

	__u32   PCIeTxMcastFrameCount;
	__u32   rsvd;
} __attribute__ ((__packed__)) cs_mib_pcie_t;

typedef struct mib_ni_s {
	__u32   NIRxGEFrameCount;	// Frame count from GE
	__u32   NIRxA9FrameCount;	// Frame count from A9 through PNI

	__u32   NITxGEFrameCount;	// Frame count to GE
	__u32   NITxA9FrameCount;	// Frame count to A9 through PNI

	__u32   NIRxGEByteCount;	// Byte count of frames from GE
	__u32   NIRxA9ByteCount;	// Byte count of frames from A9 through PNI

	__u32   NITxGEByteCount;	// Byte count of frames to GE
	__u32   NITxA9ByteCount;	// Byte count of frames to A9 through PNI

	__u32   NIRXGEDropFrameCount;
	__u32   NIRXA9DropFrameCount;

	__u32   NIRxBcastFrameCount;
	__u32   NITxBcastFrameCount;

	__u32   NIRxMcastFrameCount;
	__u32   NITxMcastFrameCount;

	__u32	 rsvd[2];
} __attribute__ ((__packed__)) cs_mib_ni_t;

typedef struct mib_ipc_s {
	__u32   IpcRcvCnt;		// IPC message count from A9 to PE
	__u32	 IpcRspCnt;		// IPC message count from PE to A9

	__u32   PEFiFoStatus;		// HW FIFO depth status (RECPU_RX_CRYPTO_DST_FF_STS)
	__u32	 PENIXferCnt;		// HW FIFO depth status (RECPU_CRYPTO_RX_RETURN_FF_STS)
...
typedef struct mib_pe_s {
	/* PE 0 MIB */
	cs_mib_pcie_t pe0_pci;
	cs_mib_ni_t   pe0_ni;
	cs_mib_ipc_t  pe0_ipc;

	/* PE 1 MIB */
	cs_mib_pcie_t pe1_pci;
	cs_mib_ni_t   pe1_ni;
	cs_mib_ipc_t  pe1_ipc;
