...
static int enablePort5TxDelay = 1;
...
static long bcm53125_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	static u8 readWriteBuffer[BCM53125_SPI_MAX_DATA_RW];
...
static int bcm53125_init_switch_chip(void)
{
	...
	if (enablePort5TxDelay) {
		/* Enable Port 5 RGMII TX delay */
		CHECK_ERR( bcm53125_write_u8(drvData.spiDev, ROBO_CTRL_PAGE, ROBO_RGMII_PORT5_TIMING, 0x01) );
	}
...
module_param(enablePort5TxDelay, bool, S_IRUGO);
